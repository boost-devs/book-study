...
> <strong><i>p68. 잘 돌아가는 코드라 해도 세상에 맞춰 변화할 수 있또록 더 나은 코드, 더 나은 구조로 변경할 수 있는 용기가 우리에게 필요하다.</i></strong> 🐧
...
> <strong><i>p86. 이름음 짧을수록 좋지만 사용 범위가 넓다면 서술적인 이름을 사용해야 한다. </i></strong> 🐤
