...
> <strong><i>p199. 처음부터 올바르게 시스템을 만들 수 있다는 믿음은 미신이다.</i></strong> 🙂
...
> <strong><i>p217. 리팩토링 단계에서 응집도를 높이고, 결합돌ㄹ 낮추고, 관심사를 분리하는 등..프로그래머의 의도를 표현하고, 클래스와 메서드 수를 최소로 줄이는 단계이기도 한다.</i></strong> 🙂
