...
> <strong><i>p147. 곧바로 우리쪽 코드를 작성해 외부 코드를 호출하는 대신 먼저 간단한 테스트 케이스를 작성해 외부 코드를 익히면 어떨까? .. 이를 학습 테스트라 부른다.</i></strong> 🍋

> <strong><i>p152. 외부 패키지를 호출하는 코드를 가능한 줄여 경계를 관리하자.</i></strong> 🍋
