...
> <strong><i>p254. 프로그래밍은 과학보다는 공예에 가깝다. </i></strong> 🌵

> <strong><i>p254. 깨끗한 코드를 짜려면 지저분한 코드를 짠 뒤에 정리해야 한다는 의미다. </i></strong> 🍋
...
> <strong><i>p270. 프로그램을 망치는 가장 좋은 방법 중 하나는 개선이라는 이름 아래 구조를 크게 뒤집는 행위다. 어떤 프로그램은 그저 그럼'개선'에서 결코 회복하지 못한다. '개선'전과 똑같이 프로그램을 돌리기가 아주 어렵기 때문이다. </i></strong> 🍋
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td align='center'><code>브</code></td>
      <td></td>
    </tr>
  </tbody>
</table>
