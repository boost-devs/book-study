<div align="center">
  <a href="https://product.kyobobook.co.kr/detail/S000001766399">
...
> <strong><i>p212. 이처럼 제안에는 고객의 문제 인식과 제안사의 문제 해결 능력이 ‘문제’다.</i></strong> 🍋
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>이 책에 대한 느낀점을 ... 완독하고 몇 개월이 지난 다음에서야 적게됐다. 이 책에서 알게된 부분을 지금의 나는 제대로 수행하고 있는지 점검하게 되는데, 잊어버린 내용도 잘 실천하고 있지 못한 부분도 많은 것 같다. 이렇게 스터디를 하면서 나눴던 정보와 그 당시의 마음가짐을 잃지 않기 위해서라도, 여기 자주 들어와서 우리가 써둔 글을 봐야겠다.</td>
    </tr>
    <tr>
      <td align='center'><code>후미</code></td>
      <td>개발자는 혼자 일할 수 없기 때문에 팀원간의 `소통`이 정말 중요하다. `소통`을 잘하기 위해서는 이해하기 쉬운 변수명 짖기, 자신이 한 일에 대해 정리를 잘하기 등이 있다. 이 책에서 나온 여러 팁 중 변수명을 어떻게 지어야될지, 문서 작성하는 방법들은 책을 읽고 지금까지 잘 쓰고 있어 책 읽은 효과를 잘 보고 있다. ㅎㅎ p.s. 책에서 release note 쓰는 방법을 인상 깊게 본 이후, 프로그램이 배포 될때마다 release note를 읽는 소소한 재미도 생겼다. </td>
    </tr>
    <tr>
